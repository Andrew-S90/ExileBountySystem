...
[_sessionID, "toastRequest", ["SuccessTitleAndText", ["Bounty Hunter Died!", format ["+%1<img image='\exile_assets\texture\ui\poptab_inline_ca.paa' size='24'/>", _poptabReward]]]] call ExileServer_system_network_send_to;
_perks pushBack ["Bounty Hunter Died!", _respectReward];
...
diag_log format["BOUNTY REWARD: %1 EARNED %2 POPTABS AND %3 RESPECT: HUNTERDIED",_playerObject,_poptabReward,_respectReward];