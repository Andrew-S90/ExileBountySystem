...
[_sessionID, "toastRequest", ["SuccessTitleAndText", ["Bounty Hunter Killed!", format ["+%1<img image='\exile_assets\texture\ui\poptab_inline_ca.paa' size='24'/>", _poptabReward]]]] call ExileServer_system_network_send_to;

diag_log format["BOUNTY REWARD: %1 EARNED %2 POPTABS: HUNTERKILLED",_playerObject,_poptabReward];
